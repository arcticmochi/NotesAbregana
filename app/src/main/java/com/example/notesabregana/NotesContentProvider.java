...
public class NotesContentProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://com.example.notesabregana.notesprovider/notes");
    ...
    static {
        ...
        matcher.addURI("com.example.notesabregana.notesprovider", "notes", ALL_ROWS);
        matcher.addURI("com.example.notesabregana.notesprovider", "notes/#", SINGLE_ROW);
    }
    ...
    public int delete(@NonNull Uri uri, @Nullable String s, @Nullable String[] strings) {
        ...
        switch (matcher.match(uri)) {
            case SINGLE_ROW:
                ...
                //Identify if s if empty or not
                if (!TextUtils.isEmpty(s)) {
                    //Append s to selector
                    row += " AND ( " + s + " )";
                } s = row;
            default:
                break;
